    ...
    <header className="fixed top-0 w-full bg-white/10 backdrop-blur-lg z-50 border-b border-white/20">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/site" className="text-white hover:text-pink-300 transition">
            Início
          </Link>
          <Link href="#planos" className="text-white hover:text-pink-300 transition">
            Planos
          </Link>
          <Link href="#sobre" className="text-white hover:text-pink-300 transition">
            Sobre
          </Link>
          <Link href="#contato" className="text-white hover:text-pink-300 transition">
            Contato
          </Link>
        </nav>
      ...
      <div className="container mx-auto text-center">
        ...
        >
          ...
          <div className="inline-block bg-white/10 backdrop-blur-lg border border-white/20 rounded-full px-6 py-2 mb-8">
            <span className="text-pink-300 font-semibold">✨ Sua assistente virtual de negócios</span>
          </div>
          
          {/* Título */}
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Conheça a <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">SARA</span>
          </h1>
  ...
  const beneficios = [
    {
      ...
      descricao: 'Controle completo de horários e serviços. Fila de espera inteligente com encaixe em 1 clique.'
    },
    {
      icon: '💬',
      titulo: 'Chatbot WhatsApp Oficial',
      descricao: 'Integração oficial com Meta para atendimento automatizado 24/7 via WhatsApp.'
    },
    {
      icon: '💳',
      titulo: 'Pagamentos Online',
      descricao: 'Receba por PIX, cartão de crédito e débito com integração Asaas.'
    },
    {
      icon: '📊',
      titulo: 'Dashboard em Tempo Real',
      descricao: 'Acompanhe faturamento, agendamentos e métricas atualizadas em tempo real.'
    },
    {
      icon: '💰',
      titulo: 'Controle Financeiro',
      descricao: 'Gerencie receitas e despesas do dia a dia com gráficos e exportação para PDF.'
    },
    {
      icon: '🔔',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {beneficios.map((beneficio, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-3">{beneficio.titulo}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {passos.map((passo, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-3">{passo.titulo}</h3>
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <div className="text-gray-700">R$ 1,89 por cobrança liquidada</div>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                <div className="font-bold text-purple-600 mb-1">Cartão de Crédito (2-6x)</div>
                <div className="text-gray-700">3,12% por transação</div>
              </div>
              
              <div className="bg-purple-50 rounded-lg p-4">
                <div className="font-bold text-purple-600 mb-1">Cartão de Crédito (7-12x)</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-gray-700">
                <strong>Importante:</strong> A taxa de 3% do SARA é calculada sobre o valor líquido após o split de pagamento, não sobre o valor bruto da transação.
              </p>
            </div>
...
function Footer() {
  return (
    <footer id="contato" className="bg-black/30 border-t border-white/10 py-12 px-4">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#planos" className="text-white/60 hover:text-white transition">Planos</Link></li>
              <li><Link href="/site/download" className="text-white/60 hover:text-white transition">Download</Link></li>
              <li><Link href="/login" className="text-white/60 hover:text-white transition">Login</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#sobre" className="text-white/60 hover:text-white transition">Sobre</Link></li>
              <li><Link href="#contato" className="text-white/60 hover:text-white transition">Contato</Link></li>
            </ul>
          </div>
